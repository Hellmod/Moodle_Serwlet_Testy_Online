...
<form action="TEST?akcja=editTest" method="post" accept-charset="UTF-8">
    ...
    <label>Data od:</label>    <input type="datetime-local" name="odData" value="${Test.ft.format(testList.get(0).getOdData())}"> <br/>
    <label>Data do:</label>    <input type="datetime-local" name="doData" value="${Test.ft.format(testList.get(0).getDoData())}"> <br/>
